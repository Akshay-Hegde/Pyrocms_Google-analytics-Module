...
class GoogleAnalyticsAPI {
	 ...
	 * @access public
	 * @param String $auth
	 *        	(default: 'web') 'web' for Web-applications with end-users involved, 'service' for service applications (server-to-server)
	 */
	 ...
	 * @access public
	 * @param array $params
	 *        	(default: array()) Query parameters
	 * @return array data
	 */
	...
	public function getWebProperties() {
		...
		$data = Http::curl ( self::WEBPROPERTIES_URL, array (
	...
	public function getProfiles() {
		...
		$data = Http::curl ( self::PROFILES_URL, array (
				'access_token' => $this->accessToken 
		) );
		return json_decode ( $data, $this->assoc );
	}
	...
	protected function _query($params = array()) {
		...
		$_params = array_merge ( $this->defaultQueryParams, array (
				'access_token' => $this->accessToken,
				'ids' => $this->accountId 
		) );
...
class GoogleOauthService extends GoogleOauth {
	 ...
	 *        	(default: '') Client-ID of your project from the Google APIs console
	 * @param string $email
	 *        	(default: '') E-Mail address of your project from the Google APIs console
	 * @param mixed $privateKey
	 *        	(default: null) Path to your private key file (*.p12)
	 */
	 ...
	 * @access public
	 * @param mixed $data
	 *        	(default: null) No data needed in this implementation
...
class GoogleOauthWeb extends GoogleOauth {
	 ...
	 * @access public
	 * @param string $clientId
	 *        	(default: '') Client-ID of your web application from the Google APIs console
	 * @param string $clientSecret
	 *        	(default: '') Client-Secret of your web application from the Google APIs console
	 * @param string $redirectUri
	 *        	(default: '') Redirect URI to your app - must match with an URL provided in the Google APIs console
	 */
	 ...
	 * @access public
	 * @param mixed $data
	 *        	The code received with GET after auth
...
class Http {
	 ...
	 * @param array $params
	 *        	(default: array()) Array with key/value pairs to send
	 * @param bool $post
	 *        	(default: false) True when sending with POST
	 */
